...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const endElement = useWindowScroll
      ? document.querySelector<HTMLDivElement>(".scroll-stack-end")
      : scrollerRef.current?.querySelector<HTMLDivElement>(".scroll-stack-end");
  ...
  useLayoutEffect(() => {
    ...
    const scroller = scrollerRef.current ?? document.documentElement;
    if (!scroller) return;
